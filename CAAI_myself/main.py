...
from models2 import CompGCN_DistMult,ConvE
...
def main(args):
    ...
    # checkpoint = th.load('checkpoint1/baseline_ckpt.pth')
    ...
    get_candidate_voter_list(compgcn_model, graph, device, data, submit_path, top_k=10)
